...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 40; position: fixed; top: 0; left: 0; height: 100vh; object-fit: contain; width: 100vw; opacity: 0.15; background: center / cover no-repeat url('https://raw.githubusercontent.com/SanariSan/_/master/lK9LM8Z.gif');]{x0000}$}
